  ...
  return (
    <div className="text-center overflow-visible m-40" id='contact'>
      ...
      <a className="w-[150px]" href="mailto:harshshekhawat963@gmail.com" target="blank">
        <div className="font-mono w-[150px] hover:scale-90  text-sm relative top-10 tracking-wide m-auto rounded-[4px] border-[1px] flex justify-center items-center rounded-[4px] border-[1px] h-[50px] text-center h-10  border-[#64ffda] text-[#64ffda]">
          <p>Mail Me Here</p>
        </div>
      </a>
    </div>
