...
const Info = () => {
  return (
    <div className="w-full fixed flex justify-between z-10 left-4 bottom-0">
      <div className="">
      ...
      <a href="mailto:harshshekhawat963@gmail.com" target="_blank">
            <p className="origin-center relative top-10 left-11 hover:text-[#64ffda] hover:-translate-y-1 transition duration-150 ease-in-out  rotate-90 font-thin tracking-wide  font-mono text-[#8892b0]">
